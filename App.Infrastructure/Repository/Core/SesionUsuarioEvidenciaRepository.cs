...
namespace App.Infrastructure.Repository.Core
{
    public class SesionUsuarioEvidenciaRepository : ISesionUsuarioEvidenciaRepository
    {
        ...
        public async Task<Guid> AddAsync(Guid sesionUsuarioId, Stream content, string originalFileName, CancellationToken cancellationToken = default)
        {
            ...
            const string query = "INSERT INTO sesion_usuario_evidencia (sesion_usuario_id, ruta_foto, created_at) VALUES (@sesion_usuario_id, @ruta_foto, @created_at) RETURNING id";
