...
namespace App.WebApi.Services
{
 ...
 var usuario = await _unitOfWork.Usuarios.GetByNameAsync(request.usuario);

 if (usuario != null)
 {
 if (App.Infrastructure.Crypto.VerifyHashedPassword(usuario.contrasena_hash, request.clave))
 {
